...
export function IconDocumentLarge({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="28"
...
export function IconMail14({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="14"
...
export function IconPhone14({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="14"
...
export function IconLinkedIn14({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="14"
...
export function IconLinkedIn20({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="20"
...
export function IconBroom({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="28"
      ...
      aria-hidden
    >
      <path d="M4 22h16M6 18l2-10 4 2 2-6 4 3-2 11" />
      <path d="M10 10l-2 8M14 8l2 10" />
    </svg>
  );
}
